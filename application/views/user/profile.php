<div class="navbar">
	...
	<div class="hero-unit">
		<div class="row-fluid">
      		<div class="span2 "></div>
      		<div class="span8 underlinez">
      			<span class='large-txt text-white-shadw'>Create an account</span>
      			<span class="pull-right">
      				<span class="large-txt">(</span>or <a href="#">sign in</a><span class="large-txt">)</span>
      			</span>
      		</div>
      		<div class="span2 "></div>
      	</div>
        ...
        <div class="row-fluid">
        	...
        	<div class="span8 ">
        		<div class="row-fluid">
        			<div class="span3 "></div>
        			<div class="span6 ">
				        <form class="form-horizontal" name="user-reg" id="userRegForm" action="<?php echo site_url('user/register');?>" method="post">	      	
					      	<div class="control-group">
						   	...
						   	<div id='burl' data-baseurl="<?php echo base_url() ?>" data-coder="nayaks"></div>
							<div class="control-group">
							...
							<div class="control-group">
						  	...
						  	<div class="control-group">
						  		<div class="controls">
						    		<input type="checkbox" name="agree_tos" id="agreeTOS" class="input-large">
						    		<span class="">I agree to the <a href="#">Terms of Service</a></span>
						    	</div>
						  	...
						  	<div class="row-fluid ">
						  		<div class="span6 "></div>
						  		<div class="span4 "><input type="submit" name="register" class="btn btn-vlarge-h btn-primary" value="Register" /></div>
						  		<div class="span2 "></div>
						  	</div>
						  	<br />
